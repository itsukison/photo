...
export async function fetchPlans(): Promise<Plan[]> {
  ...
  const enrichedDescriptions: Record<string, string> = {
    quick: "A refined, high-efficiency session designed for the modern traveler. We'll navigate one of Tokyo's most iconic districts together, capturing effortless, cinematic street-style portraits that reflect your personal aesthetic in just 30 minutes.",
    portrait: "A narrative-driven 60-minute exploration across two distinct Tokyo backdrops. This plan offers a comprehensive visual story, perfect for professional portfolios or fashion-forward social presence, with enough time for subtle outfit shifts and deeper creative direction.",
